    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.percentage) {
            this.$http({
              url: this.$http.adornUrl(`/productionplan/department/info/${this.dataForm.percentage}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/productionplan/department/${!this.dataForm.percentage ? 'save' : 'update'}`),
              method: 'post',
