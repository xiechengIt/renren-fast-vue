<template>
  <el-dialog
    ...
    <el-form-item label="接收时间" prop="receiptTime">
      <el-input v-model="dataForm.receiptTime" placeholder="接收时间"></el-input>
    </el-form-item>
    ...
    <el-form-item label="规格型号" prop="specifications">
      <el-input v-model="dataForm.specifications" placeholder="规格型号"></el-input>
    </el-form-item>
    ...
    <el-form-item label="间隔秒" prop="intervalSecond">
      <el-input v-model="dataForm.intervalSecond" placeholder="间隔秒"></el-input>
    </el-form-item>
    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/productionplan/qucarddata/info/${this.dataForm.id}`),
              method: 'get',
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.productPlanAmount = data.quCarddata.productPlanAmount
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/productionplan/qucarddata/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
