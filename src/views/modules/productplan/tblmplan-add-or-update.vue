<template>
  <el-dialog
    ...
    <el-form-item label="等待时间" prop="waitingTime">
      <el-input v-model="dataForm.waitingTime" placeholder="等待时间"></el-input>
    </el-form-item>
    <el-form-item label="工单号" prop="workOrderId">
      <el-input v-model="dataForm.workOrderId" placeholder="工单号"></el-input>
    </el-form-item>
    <el-form-item label="工单数量" prop="billAmount">
      <el-input v-model="dataForm.billAmount" placeholder="工单数量"></el-input>
    </el-form-item>
    <el-form-item label="订单号" prop="orderId">
      <el-input v-model="dataForm.orderId" placeholder="订单号"></el-input>
    </el-form-item>
    <el-form-item label="订单数量" prop="orderAmount">
      <el-input v-model="dataForm.orderAmount" placeholder="订单数量"></el-input>
    </el-form-item>
    ...
    <el-form-item label="计划生产数量" prop="productPlanAmount">
      <el-input v-model="dataForm.productPlanAmount" placeholder="计划生产数量"></el-input>
    </el-form-item>
    <el-form-item label="实际完成数量" prop="endAmount">
      <el-input v-model="dataForm.endAmount" placeholder="实际完成数量"></el-input>
    </el-form-item>
    <el-form-item label="实际剩余数量" prop="restAmount">
      <el-input v-model="dataForm.restAmount" placeholder="实际剩余数量"></el-input>
    </el-form-item>
    <el-form-item label="计划开始日期" prop="planBeginTime">
      <el-input v-model="dataForm.planBeginTime" placeholder="计划开始日期"></el-input>
    </el-form-item>
    <el-form-item label="计划结束日期" prop="planEndTime">
      <el-input v-model="dataForm.planEndTime" placeholder="计划结束日期"></el-input>
    </el-form-item>
    <el-form-item label="实际开始日期" prop="beginTime">
      <el-input v-model="dataForm.beginTime" placeholder="实际开始日期"></el-input>
    </el-form-item>
    <el-form-item label="手工结案" prop="manualFinish">
      <el-input v-model="dataForm.manualFinish" placeholder="手工结案"></el-input>
    </el-form-item>
    <el-form-item label="实际剩余工时" prop="restTime">
      <el-input v-model="dataForm.restTime" placeholder="实际剩余工时"></el-input>
    </el-form-item>
    <el-form-item label="实际结束日期" prop="endTime">
      <el-input v-model="dataForm.endTime" placeholder="实际结束日期"></el-input>
    </el-form-item>
    <el-form-item label="理论材料总量kg" prop="materialTotalKg">
      <el-input v-model="dataForm.materialTotalKg" placeholder="理论材料总量kg"></el-input>
    </el-form-item>
    <el-form-item label="理论材料已用kg" prop="materialUsedKg">
      <el-input v-model="dataForm.materialUsedKg" placeholder="理论材料已用kg"></el-input>
    </el-form-item>
    <el-form-item label="理论材料结余kg" prop="materialRestKg">
      <el-input v-model="dataForm.materialRestKg" placeholder="理论材料结余kg"></el-input>
    </el-form-item>
    <el-form-item label="产能H" prop="advancedTimeh">
      <el-input v-model="dataForm.advancedTimeh" placeholder="产能H"></el-input>
    </el-form-item>
    <el-form-item label="制单日期" prop="makeBillTime">
      <el-input v-model="dataForm.makeBillTime" placeholder="制单日期"></el-input>
    </el-form-item>
    ...
    <el-form-item label="是否生产" prop="ifProduct">
      <el-input v-model="dataForm.ifProduct" placeholder="是否生产"></el-input>
    </el-form-item>
    ...
    <el-form-item label="警报数量" prop="warningAmount">
      <el-input v-model="dataForm.warningAmount" placeholder="警报数量"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          materialTotalKg: [
            { required: true, message: '理论材料总量kg不能为空', trigger: 'blur' }
          ],
          materialUsedKg: [
            { required: true, message: '理论材料已用kg不能为空', trigger: 'blur' }
          ],
          materialRestKg: [
            { required: true, message: '理论材料结余kg不能为空', trigger: 'blur' }
          ],
          advancedTimeh: [
    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/productionplan/tblmplan/info/${this.dataForm.id}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/productionplan/tblmplan/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
